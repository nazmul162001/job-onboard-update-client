  ...
  return (
    <section className='manage_opening_jobs grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 mx-20'>
      ...
      <div className="opening_main">
        ...
        <a className='text-blue-600 flex items-center' href="#_">Read more <span><i className="ri-arrow-right-line ml-2"></i></span> </a>
      </div>
      {/* opening positions  */}
      ...
      <div className="opening_positions my-5">
        <div className="img flex justify-center items-center">
          <img className='w-60' src={openingBig} alt="/opening positions images" />
        </div>
      </div>
      {/* tracing image */}
      <div className="opening_positions my-5">
