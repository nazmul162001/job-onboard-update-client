      ...
      <div className="w-2/5 bg-base-100 shadow-xl p-4">
        <div className="c-body">
            ...
            <div className="pricing-title flex items-center">
              ...
              <div className="pricing_description">
                <h4 className="pricing_category text-lg font-medium">
                  Upgraded to <span className="font-bold">{paymentDetails.category}</span>
                </h4>
          ...
          <div className="payment-method">
            ...
            <div className="pricing-title flex items-center">
              <div className="pricing_image">
              <img className="w-28 h-24 mr-3" src={visa} alt="" />  
              </div>
              <div className="pricing_description">
                <h4 className="pricing_category text-lg font-medium">
                  Pay with Visa Card
                </h4>
                <h5 className="text-gray opacity-60">Make sure before you payment</h5>
              </div>
            </div>
          </div>
